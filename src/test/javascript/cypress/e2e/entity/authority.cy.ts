...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '7a9c882d-55c9-43f1-94f1-cc62abc1ce74' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5fa81101-c052-4380-8d88-9f54a10a6ba2');
      cy.get(`[data-cy="name"]`).should('have.value', '5fa81101-c052-4380-8d88-9f54a10a6ba2');
